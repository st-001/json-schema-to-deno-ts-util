...
function generateCode(
  ...
  let code = generateAutoGeneratedComment() + "\n";
  code += `import Ajv from "https://esm.sh/ajv@8.12.0";\n`;
  code += `import addFormats from "https://esm.sh/ajv-formats@2.1.1";\n`;
  code += generateTypeDefinitionInterface(originalSchema) + "\n";
  code += generateTypeDefinitionInterface(compressedSchema) + "\n";
  // Start the class definition
  code += `export class ${originalSchema.$id}Util {\n`;
