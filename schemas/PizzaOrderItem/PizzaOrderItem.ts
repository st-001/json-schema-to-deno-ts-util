...
export interface PizzaOrderItemCompressed { 1: "tomato" | "1" | "2"; 2: string[]; 3: number | string; size: "small" | "1" | "2";}
...
export const schemaCompressed = {"$id":"PizzaOrderItem","type":"object","description":"A pizza order item.","properties":{"1":{"type":"string","description":"The type of sauce on the pizza. Enum mapping: 0 = tomato, 1 = white, 2 = bbq.","enum":["tomato",1,2],"default":0},"2":{"type":"array","description":"The list of toppings on the pizza.","items":{"type":"string"},"default":[]},"3":{"type":"number","description":"The quantity of the pizza.","default":1,"minimum":1},"size":{"type":"string","description":"The size of the pizza. Enum mapping: 0 = small, 1 = medium, 2 = large.","enum":["small",1,2],"default":1}},"required":["size",1,2,3]};
